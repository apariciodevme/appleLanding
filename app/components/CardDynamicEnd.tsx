...
const CardDynamicEnd = ({title, text, bg, btnLeft, btnRight}: Props) => {
  return (
    <div className="w-full mb-3 rounded-none card image-full min-h-96 h-[500px]">
      ...
      <div className="z-20 flex flex-col items-center justify-end gap-2 p-10 mx-20 text-center">
      <h1 className="text-3xl font-semibold text-white">{title}</h1>
      <p className="font-normal text-white text-md">{text}</p>
